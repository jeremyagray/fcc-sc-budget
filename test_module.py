...
class UnitTests(unittest.TestCase):
    ...
    def test_deposit(self):
        ...
        self.assertEqual(actual,
                         expected,
                         'Expected `deposit` method to create a '
    ...
    def test_withdraw_no_description(self):
        ...
        self.assertEqual(actual,
                         expected,
                         'Expected `withdraw` method with no description '
                         'to create a blank description.')
        self.assertEqual(good_withdraw,
                         True,
    ...
    def test_transfer(self):
        ...
        self.assertEqual(actual,
                         expected,
                         'Expected `transfer` method to create a specific '
                         'ledger item in food object.')
        self.assertEqual(good_transfer,
                         True,
                         'Expected `transfer` method to return `True`.')
        ...
        self.assertEqual(actual,
                         expected,
                         'Expected `transfer` method to create a specific '
                         'ledger item in entertainment object.')
